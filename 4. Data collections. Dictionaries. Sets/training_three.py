...
for index, course in enumerate(courses_list):
	mentors_count = len(course.get('mentors'))
	duration = course.get('duration')
	duration_index.append([duration, index])
	mcount_index.append([mentors_count, index]) # напишите код по аналогии с duration_index
